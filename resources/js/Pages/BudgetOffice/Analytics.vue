...
<template>
  ...
  <Deferred data="analyticsData">
    <div class="flex flex-wrap gap-8 mt-8">
      ...
      <div class="flex-1 min-w-[180px]">
        <AppKpiCard title="Approved" :value="analyticsData?.total_approved ?? 0" icon="pi pi-check-circle" color="success" subtitle="forwarded to accountant" />
      </div>
      <div class="flex-1 min-w-[180px]">
        <AppKpiCard title="On Hold" :value="analyticsData?.total_held ?? 0" icon="pi pi-pause-circle" color="danger" subtitle="vouchers on hold" />
      </div>
      <div class="flex-1 min-w-[180px]">
