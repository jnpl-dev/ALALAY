    ...
    <div class="col-span-12">
      <div class="card">
        <div class="flex items-center justify-between mb-6">
          ...
          <AppExportButton
            :url="route('aics.assistance-codes.export')"
            :params="exportParams"
          />
        </div>
                ...
                <Column header="Actions" style="width: 6rem">
                  <template #body="{ data }">
                    <Button icon="pi pi-pencil" severity="info" text rounded size="small"
                      v-tooltip="'Assign code'"
                      @click="router.get(route('aics.assistance-codes.show', data.id))" />
                  </template>
                </Column>
                <template #empty>
                  <AppEmptyState icon="pi pi-inbox" message="No applications pending coding" />
                </template>
              </DataTable>
                ...
                <Column header="Actions" style="width: 6rem">
                  <template #body="{ data }">
                    <Button icon="pi pi-eye" severity="info" text rounded size="small"
                      v-tooltip="'View code details'"
                      @click="router.get(route('aics.assistance-codes.show', data.id))" />
                  </template>
                </Column>
                <template #empty>
                  <AppEmptyState icon="pi pi-check-circle" message="No coded applications" />
                </template>
              </DataTable>
