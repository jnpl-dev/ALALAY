...
const tabIndex = ['pending', 'ready', 'claimed'].indexOf(props.tab)
...
function onTabChange(event) {
  const tabValues = ['pending', 'ready', 'claimed']
  router.get(route('treasurer.cheques.index'), {
        ...
        <TabView :activeIndex="tabIndex" @tab-change="onTabChange">
          ...
          <TabPanel header="Completed">
            ...
            <DataTable :value="toRaw(tableData)" striped-rows class="w-full">
              ...
              <template #empty>
                <AppEmptyState icon="pi pi-check-circle" message="No completed cheques" />
              </template>
            </DataTable>
