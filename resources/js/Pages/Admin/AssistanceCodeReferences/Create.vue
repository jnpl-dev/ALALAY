...
<template>
  <Head title="Create Code Reference" />

  <div class="grid grid-cols-12 gap-8">
    <div class="col-span-12">
      <div class="card">
        <div class="font-semibold text-xl mb-4">Create Code Reference</div>
        ...
        <form @submit.prevent="submit">
          ...
          <div class="flex justify-end gap-4">
            ...
            <Button type="submit" label="Create Code Reference" icon="pi pi-check" :loading="form.processing" />
          </div>
        </form>
      </div>
    </div>
