...
<template>
  ...
  <div class="grid grid-cols-12 gap-8">
    <div class="col-span-12">
      <div class="card">
        <div class="font-semibold text-xl mb-4">Create Required Document</div>
        ...
        <form @submit.prevent="submit">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6 max-w-xl">
            ...
            <div class="flex items-center gap-3">
              <ToggleSwitch id="is_mandatory" v-model="form.is_mandatory" />
          ...
          <div class="flex justify-end gap-4">
            ...
            <Button type="submit" label="Create Document" icon="pi pi-check" :loading="form.processing" />
          </div>
        </form>
      </div>
    </div>
