    ...
    <div class="grid grid-cols-12 gap-8">
      <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
          ...
          <span class="text-muted-color">registered accounts</span>
        </div>
      </div>
      ...
      <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
          <div class="flex justify-between mb-4">
            <div>
              <span class="block text-muted-color font-medium mb-4">Active</span>
              <div class="text-surface-900 font-medium text-xl">0</div>
            </div>
          ...
          <span class="text-primary font-medium">— </span>
          <span class="text-muted-color">active accounts</span>
        </div>
      </div>
      ...
      <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <div class="card mb-0">
          <div class="flex justify-between mb-4">
            <div>
              <span class="block text-muted-color font-medium mb-4">Inactive</span>
              <div class="text-surface-900 font-medium text-xl">0</div>
            </div>
          ...
          <span class="text-primary font-medium">— </span>
          <span class="text-muted-color">deactivated accounts</span>
        </div>
      </div>
