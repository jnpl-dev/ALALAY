...
<template>
  ...
  <Deferred data="analyticsData">
    <div class="flex flex-wrap gap-8 mt-8">
      ...
      <div class="flex-1 min-w-[180px]">
        <AppKpiCard title="Approved" :value="analyticsData?.total_approved ?? 0" icon="pi pi-check-circle" color="success" subtitle="moved to voucher creation" />
      </div>
      <div class="flex-1 min-w-[180px]">
        <AppKpiCard title="Returned" :value="analyticsData?.total_returned ?? 0" icon="pi pi-undo" color="danger" subtitle="sent back to AICS" />
      </div>
      <div class="flex-1 min-w-[180px]">
