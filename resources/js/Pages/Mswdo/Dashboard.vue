...
<template>
  ...
  <Deferred data="dashboardData">
    <div class="grid grid-cols-12 gap-8">
      ...
      <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <AppKpiCard title="Pending Voucher" :value="dashboardData?.pending_voucher_creation ?? 0" :change="dashboardData?.pending_voucher_creation_change" change-label="vs last week" icon="pi pi-receipt" color="warn" />
      </div>
      <div class="col-span-12 lg:col-span-6 xl:col-span-3">
        <AppKpiCard title="Vouchers Today" :value="dashboardData?.vouchers_created_today ?? 0" :change="dashboardData?.vouchers_created_change" change-label="vs yesterday" icon="pi pi-verified" color="purple" />
      </div>
